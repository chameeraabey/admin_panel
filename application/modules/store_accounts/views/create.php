        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" method="post" action="<?= $form_location ?>">
                <fieldset>                    
                    ...
                    <div class="control-group"> <label class="control-label" for="typeahead">Address Line 1 </label> <div class="controls"> <input type="text" class="span6" name="address1" value="<?= $address1 ?>"> </div> </div>
                    <div class="control-group"> <label class="control-label" for="typeahead">Address Line 2 </label> <div class="controls"> <input type="text" class="span6" name="address2" value="<?= $address2 ?>"> </div> </div>
                    ...
                    <div class="control-group"> <label class="control-label" for="typeahead">Telphone Number </label> <div class="controls"> <input type="text" class="span6" name="telnum" value="<?= $telnum ?>"> </div> </div>
